package com.example.util.test5;

/**
 * Test harness for an implementation of the Luhn algorithm that checks the
 * validity of a credit card number.
 *
 * @see https://www.freeformatter.com/credit-card-number-generator-validator.html#howToValidate
 * @see https://snipplr.com/view/7823/
 */
public class Luhn {
    /**
    ...
    public static void main(String[] args) {
        args = new String[]{"4929754782878948", "5392585235254088"};

//        args = new String[]{"4929754782878941"};
//        args = new String[]{"5392585235254081"};
